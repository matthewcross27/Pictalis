...
| Database | 22 migrations applied: schema, storage, RLS (+ perf hardening), atomic comparison (Elo computed in-RPC), phash, session stages, adaptive ranking, dedup stage, upload pipeline, local-first cull stage |
