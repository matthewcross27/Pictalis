...
| Database | 19 migrations applied: schema, storage, RLS (+ perf hardening), atomic comparison, phash, session stages, adaptive ranking, dedup stage, upload pipeline, local-first cull stage |
